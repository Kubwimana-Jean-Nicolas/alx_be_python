...
# Use Match Case to handle task priority
match priority:
    case "high":
        if time_bound == "yes":
    ...
    case _:
        ...
        if time_bound == "yes":
            print(f"Reminder: '{task}' is a task that requires immediate attention today!")
        else:
            print(f"Note: '{task}' is a task. Consider completing it when you have free time.")
